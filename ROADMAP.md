...
- [x] **T5.5 Ephemeral runners** — Roll out ARC manifests and AWS OIDC wiring with recorded programme sign-off.
  - Completed via updated ARC smoke workflow and lifecycle verifier that now confirm AWS role assumptions alongside runner drain; programme owners accepted the evidence archived under `dist/staging/arc/20251113T160000Z/`.【F:scripts/arc/verify_runner_lifecycle.py†L1-L210】【F:.github/workflows/arc-ephemeral-runner.yml†L1-L60】【F:docs/how-to-guides/manage-arc-runners.md†L1-L110】
  - Additional release evidence lives under `dist/staging/backfill/20251101T171853Z/` and `dist/staging/marquez/20251101T171901Z/cli.log`, matching the 2025-11-02 changelog entry.【F:docs/CHANGELOG.md†L1-L23】
