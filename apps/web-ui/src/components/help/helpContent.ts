...
export const helpTopics: HelpTopic[] = [
  {
    ...
    summary: 'Understand the end-to-end workflow: refine, enrich, QA, and provenance checks before handoff.',
    details:
      'Operators begin every shift by reviewing the dashboard summary tiles, then step through refine → optional enrich → QA. Each stage emits telemetry to the timeline and lineage views so that provenance is always inspectable.',
    steps: [
    ...
    keywords: ['overview', 'workflow', 'operator', 'refine', 'enrich', 'qa', 'provenance'],
  ...
  },
  {
    ...
    summary: 'Use the Import panel to drag-and-drop or browse for datasets, choose a profile, and monitor ingestion progress.',
    details:
    ...
    keywords: ['import', 'upload', 'dataset', 'drag and drop', 'profile', 'refine'],
  ...
  },
  {
    ...
    summary: 'The import dialog follows WCAG guidance for keyboard shortcuts, focus order, and announcements for assistive tech.',
    details:
    ...
    keywords: ['accessibility', 'wcag', 'keyboard', 'screen reader', 'drag drop'],
  ...
  },
  {
    ...
    summary: 'Follow each run from ingest through QA with timestamps, statuses, and lineage badges.',
    details:
  ...
  },
  {
    ...
    summary: 'HIL requests surface in the dashboard, import timeline, and activity feed with context-rich reasoning.',
    details:
  ...
  },
  {
    ...
    summary: 'Hotpass enforces retention, access control, and PII scanning aligned with POPIA and SOC2.',
    details:
  ...
  },
  {
    ...
    summary: 'Common causes: schema mismatch, unsupported encoding, or upstream API throttling.',
    details:
  ...
  },
  {
    ...
    summary: 'Speed up reviews with global search (`⌘K`), assistant handoff, and batch provenance export.',
    details:
      'Use ⌘/Ctrl + Shift + F to focus the Help search, or press `.` on a run row to open actions. The assistant can summarise QA findings or prepare briefing notes for stakeholders.',
